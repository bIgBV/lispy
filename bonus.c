...
int main(int arc, char** argv)
{
  ...
  mpc_parser_t* Word1 = mpc_new("word1");
  mpc_parser_t* Word2 = mpc_new("word2");
  ...
  mpca_lang(MPCA_LANG_DEFAULT,
      "									\
      	word1		: /a+/	;					\
	word2		: /b+/	;					\
	expression	: <word1> |<word2> | '(' <expression>+ ')' ;		\
	lispy		: /^/ <expression>+ /$/ ;			\      
      ",
     Word1, Word2, Expression, Lispy);
  ...
  mpc_cleanup(4, Word1, Word2, Expression, Lispy);
